...
if choice==2:
                c1.execute("insert into medicines_details values('paracetamal 250mg',325674,1.5,1,5)")
                ...
                c1.execute("insert into medicines_details values('paracetamal 500mg',325679,2,1.5,6)")
